...
export class AuthService {
  ...
  signup(email:string,password:string)
  {
    this.afAuth.auth.createUserWithEmailAndPassword(email,password).then(
      value => {
        this.toaster.success('Registered Successfully','Emp.Register');
        this.toaster.show('You need to verify the email!...');
  ...
  login(email:string,password:string)
  {
    this.afAuth.auth.signInWithEmailAndPassword(email,password).then(
       value => {
        ...
        {
          this.toaster.warning('Your email is not verified, please verify','Email Verify');
          this.SendVerificationMail();
          this.router.navigate(['sign-in']);
        }
      }
  ...
  resetpassword(email:string)
  {
    ...
    .then(()=>{
      this.toaster.success('Password reset link is sent to your email!..','Reset Password');
      this.router.navigate(['sign-in']);
    })
  }
}
